...
struct PopulateInitialData_v0: AsyncMigration {
    func prepare(on database: FluentKit.Database) async throws {
        ...
        // Mark: - Episodes
        let episode001 = Episode(episodeNumber: 1, title: "Un misterioso guerrero", airedAt: Date(), summary: "Tanjiro Kamado, un bondadoso joven que vende carbón, se ve obligado a abandonar su vida pacífica cuando su familia es brutalmente asesinada por un demonio, dejando solo a su hermana Nezuko y él. Determinado a vengarse y salvar a su hermana, Tanjiro se embarca en un viaje como cazador de demonios.", imageURL: "/images/episode001.jpg")

        let episode002 = Episode(episodeNumber: 2, title: "La prueba final", airedAt: Date(), summary: "Tanjiro comienza su entrenamiento como cazador de demonios en la Mansión de Urokodaki. Debe superar una dura prueba para demostrar su valía. Mientras tanto, Nezuko muestra una sorprendente habilidad para resistir sus instintos demoníacos.", imageURL: "/images/episode002.jpg")

        let episode003 = Episode(episodeNumber: 3, title: "El maestro espadachín", airedAt: Date(), summary: "Tanjiro conoce al maestro espadachín Giyuu Tomioka, quien lo somete a una prueba aún más difícil. Mientras tanto, una fuerza demoníaca se cierne sobre el monte.", imageURL: "/images/episode003.jpg")

        let episode004 = Episode(episodeNumber: 4, title: "La mansión de los Insectos", airedAt: Date(), summary: "Tanjiro y Nezuko son enviados a investigar una serie de desapariciones en una mansión cercana. Allí, se enfrentan a un peligroso demonio que controla a las víctimas con hilos de araña.", imageURL: "/images/episode004.jpg")

        let episode005 = Episode(episodeNumber: 5, title: "Mujeres arañas", airedAt: Date(), summary: "Tanjiro, Nezuko y sus compañeros se enfrentan a un grupo de demonios araña que han secuestrado a varios habitantes de un pueblo. En medio de la batalla, Tanjiro demuestra su habilidad única para percibir los sentimientos de los demonios.", imageURL: "/images/episode005.jpg")

        let episode006 = Episode(episodeNumber: 6, title: "Montaña de diversión", airedAt: Date(), summary: "El Cuerpo de Cazadores de Demonios envía a Tanjiro y sus amigos a investigar una serie de desapariciones en una montaña. Allí, se encuentran con un demonio que se alimenta de los sueños de sus víctimas.", imageURL: "/images/episode006.jpg")

        let episode007 = Episode(episodeNumber: 7, title: "Paseo nocturno", airedAt: Date(), summary: "Mientras investigan un pueblo plagado de demonios, Tanjiro y sus compañeros son emboscados por una luna demoníaca. La batalla que sigue pondrá a prueba sus habilidades y su valentía.", imageURL: "/images/episode007.jpg")

        let episode008 = Episode(episodeNumber: 8, title: "El tambor del demonio", airedAt: Date(), summary: "Tanjiro, Inosuke y Zenitsu enfrentan a un demonio tamborilero cuyo ritmo hipnótico pone a sus víctimas en un trance mortal. Mientras luchan por mantenerse despiertos, descubren los oscuros secretos de la montaña.", imageURL: "/images/episode008.jpg")

        let episode009 = Episode(episodeNumber: 9, title: "El niño demonio", airedAt: Date(), summary: "Los cazadores de demonios se encuentran con un niño demonio que ha sido manipulado por un demonio mayor. Mientras luchan contra el demonio, Tanjiro descubre un doloroso vínculo entre él y el demonio niño.", imageURL: "/images/episode009.jpg")

        let episode010 = Episode(episodeNumber: 10, title: "El misterioso hogar de los demonios", airedAt: Date(), summary: "Tanjiro y sus compañeros llegan a una montaña donde se rumorea que se encuentra la sede de la Familia Araña. Allí, descubren un antiguo y siniestro culto que adora a los demonios.", imageURL: "/images/episode010.jpg")
