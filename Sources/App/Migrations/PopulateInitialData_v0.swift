...
struct PopulateInitialData_v0: AsyncMigration {
    func prepare(on database: FluentKit.Database) async throws {
        ...
        let episode007 = Episode(episodeNumber: 7, title: "Paseo nocturno", airedAt: dateFormatter.date(from: "2022-05-22T00:00:00Z") ?? Date(), summary: "Mientras investigan un pueblo plagado de demonios, Tanjiro y sus compañeros son emboscados por una luna demoníaca. La batalla que sigue pondrá a prueba sus habilidades y su valentía.", imageURL: "/images/episode007.jpg")
